...
@RocketMQMessageListener(
        topic = QueueMsgTopics.ORDERS,
        consumerGroup = "message_publish_orders_sys_deault_p2p",
        selectorExpression = QueueMsgTags.SYSTEM_DEFAULT_P2P)
@Component
public class OrderTaskMsgP2PConsumer implements RocketMQListener<String> {

    @Override
    public void onMessage(String message) {
        log.debug("接收到订单P2P消息：【{}】=======【{}】=======",QueueMsgTopics.ORDERS,message);
