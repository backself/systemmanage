...
import os.g.zone.sso.security.LoginPrincipal;
...
public class JwtAuthorizationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        try {
            ...
            JsonResult<Void> jsonResult = JsonResult.failed(ReplyCode.ERROR_JWT_MALFORMED, message);
            ...
            PrintWriter writer = response.getWriter();
            JsonResult<Void> jsonResult = JsonResult.failed(ReplyCode.ERROR_JWT_SIGNATURE, message);
            String jsonString = JSON.toJSONString(jsonResult);
            writer.println(jsonString);
            writer.close();
            return;
            ...
            PrintWriter writer = response.getWriter();
            JsonResult<Void> jsonResult = JsonResult.failed(ReplyCode.ERROR_JWT_EXPIRED, message);
            String jsonString = JSON.toJSONString(jsonResult);
            writer.println(jsonString);
            writer.close();
            return;
            ...
            PrintWriter writer = response.getWriter();
            JsonResult<Void> jsonResult = JsonResult.failed(ReplyCode.SYSTEM_INTERNAL_ERROR, message);
            String jsonString = JSON.toJSONString(jsonResult);
            writer.println(jsonString);
            writer.close();
            return;
