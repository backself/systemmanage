...
export default defineComponent({
	...
	methods:{
		...
		changeParamsToDownloadFile(){
			...
			startTime.setDate(startTime.getDate()+1-moment(startTime).format('d'));
			entTime.setDate(startTime.getDate()+7+1-moment(startTime).format('d'));
